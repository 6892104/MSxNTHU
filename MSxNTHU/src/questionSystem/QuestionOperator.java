...
public class QuestionOperator {
    ...
    public QuestionOperator() {
        try {
            reader = new BufferedReader(new FileReader(new File("res/question_list.txt")));
            ...
            while((qTitle != null) && (qContent != null)) {
                ...
                writer = new BufferedWriter(new FileWriter("res/question_result/" + qTitle + ".txt", false));
    ...
    public void writeAnswer(String fileName, String inputAns) {
        try {
            ...
            writer = new BufferedWriter(new FileWriter("res/question_result/" + fileName +".txt", true));
